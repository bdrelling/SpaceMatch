...
## starship's ability set while the module is enabled (see [method ModuleGridState.abilities]).
...
## Aggregated into the starship's rules while the module is enabled (see [method ModuleGridState.rules]).
