...
static func start_quick_match() -> Encounter:
	return start_encounter(_player_state(), _starship_state(_DEFAULT_OPPONENT))
...
static func start_new_game() -> void:
	...
	game_state.starship = _starship_state(_DEFAULT_PLAYER)
...
static func _player_state() -> StarshipState:
	...
	return _starship_state(_DEFAULT_PLAYER)
