class_name ArcadePager
extends Control
## Shows one [ArcadeScreen] at a time and steps between them (left/right). The host adds screens —
...
var screens: Array[ArcadeScreen] = []
var _index: int = 0
...
func clear() -> void:
	for screen: ArcadeScreen in screens:
		screen.queue_free()
	screens.clear()
	_index = 0
