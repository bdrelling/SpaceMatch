...
const _SLIDER_SCENE := preload("res://scenes/debug_screen/widgets/rows/slider_row.tscn")
const _OPTION_SCENE := preload("res://scenes/debug_screen/widgets/rows/option_row.tscn")
const _TOGGLE_SCENE := preload("res://scenes/debug_screen/widgets/rows/toggle_row.tscn")
const _TEXT_SCENE := preload("res://scenes/debug_screen/widgets/rows/text_row.tscn")
const _NAV_SCENE := preload("res://scenes/debug_screen/widgets/rows/nav_row.tscn")
