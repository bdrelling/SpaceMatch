...
## an overlay over a paused match ([EncounterScreen]). Push drills into a page; back pops; Done (or back at the root)
...
const _SCENE_PATH := "res://screens/debug_screen/debug_navigator.tscn"
